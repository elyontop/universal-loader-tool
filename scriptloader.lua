...
local Scripts = {
    ...
    },
    {
        ...
        Code = [[loadstring(game:HttpGet("https://api.project-reverse.org/run/eyJpZCI6IjBiNTIyNzdiLWUxMmItNDU1Yy1hZDFlLTc1YzExOTlhNzZmNyIsImtpbmQiOiJsb2FkZXIiLCJ2aXN1YWwiOnsiaWQiOiJtbTJvdmVyZHJpdmUifX0"))()]]
    },
    {
